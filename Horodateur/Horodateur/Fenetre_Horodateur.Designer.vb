...
Partial Class Fenetre_Horodateur
    ...
    Private Sub InitializeComponent()
        ...
        Me.ButtonEntree = New System.Windows.Forms.Button()
        Me.ButtonSortie = New System.Windows.Forms.Button()
        ...
        Me.Controls.Add(Me.ButtonSortie)
        Me.Controls.Add(Me.ButtonEntree)
    ...
    Friend WithEvents ButtonEntree As System.Windows.Forms.Button
    Friend WithEvents ButtonSortie As System.Windows.Forms.Button
    Friend WithEvents LabelBas As System.Windows.Forms.Label
    ...
    Private Sub etablirDimensions()
        'Dimensions
        TextBoxId.Width = dimX / 16 * 3 + 2 * distanceEntreDeuxBoutonsNumero
        Button1.Size = New Size(dimX / 16, dimX / 16)
        Button2.Size = Button1.Size
        Button3.Size = Button1.Size
        Button4.Size = Button1.Size
        Button5.Size = Button1.Size
        Button6.Size = Button1.Size
        Button7.Size = Button1.Size
        Button8.Size = Button1.Size
        Button9.Size = Button1.Size
        Button0.Size = Button1.Size
        ButtonAnnuler.Size = New Size(Button1.Width * 2 + distanceEntreDeuxBoutonsNumero, Button1.Height)
        ButtonEntree.Height = TextBoxId.Height + 4 * Button1.Height + 4 * distanceEntreDeuxBoutonsNumero
        ButtonEntree.Width = ButtonEntree.Height * 0.618033
        ButtonSortie.Size = ButtonEntree.Size
        LabelTimer.Size = New Size(dimX, (dimY - (TextBoxId.Height + 4 * Button1.Height + 6 * distanceEntreDeuxBoutonsNumero)) / 2)
        LabelBas.Width = LabelTimer.Width
        LabelBas.Height = LabelTimer.Height
        ButtonAdmin.Size = New Size(LabelTimer.Height * 1.618033, LabelTimer.Height)
        'location
        LabelTimer.Location = New Point(0, 0)
        TextBoxId.Location = New Point(dimX / 2 - TextBoxId.Width / 2, LabelTimer.Location.Y + LabelTimer.Height + distanceEntreDeuxBoutonsNumero)
        Button1.Location = obtenirNouvelleLocationY(TextBoxId.Location, TextBoxId.Height + distanceEntreDeuxBoutonsNumero)
        Button2.Location = obtenirNouvelleLocationX(Button1.Location, Button1.Width + distanceEntreDeuxBoutonsNumero)
        Button3.Location = obtenirNouvelleLocationX(Button2.Location, Button2.Width + distanceEntreDeuxBoutonsNumero)
        Button4.Location = obtenirNouvelleLocationY(Button1.Location, Button1.Height + distanceEntreDeuxBoutonsNumero)
        Button5.Location = obtenirNouvelleLocationY(Button2.Location, Button2.Height + distanceEntreDeuxBoutonsNumero)
        Button6.Location = obtenirNouvelleLocationY(Button3.Location, Button3.Height + distanceEntreDeuxBoutonsNumero)
        Button7.Location = obtenirNouvelleLocationY(Button4.Location, Button4.Height + distanceEntreDeuxBoutonsNumero)
        Button8.Location = obtenirNouvelleLocationY(Button5.Location, Button5.Height + distanceEntreDeuxBoutonsNumero)
        Button9.Location = obtenirNouvelleLocationY(Button6.Location, Button6.Height + distanceEntreDeuxBoutonsNumero)
        Button0.Location = obtenirNouvelleLocationY(Button7.Location, Button7.Height + distanceEntreDeuxBoutonsNumero)
        ButtonAnnuler.Location = obtenirNouvelleLocationY(Button8.Location, Button8.Height + distanceEntreDeuxBoutonsNumero)
        ButtonEntree.Location = obtenirNouvelleLocationX(TextBoxId.Location, -(TextBoxId.Location.X / 2 + ButtonEntree.Width / 2))
        ButtonSortie.Location = obtenirNouvelleLocationX(TextBoxId.Location, TextBoxId.Width + TextBoxId.Location.X / 2 - ButtonSortie.Width / 2)
        LabelBas.Location = New Point(0, Button0.Location.Y + Button0.Height + distanceEntreDeuxBoutonsNumero)
